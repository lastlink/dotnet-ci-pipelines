...
copy "MyProject\bin\Release\netcoreapp2.2\publish\ReadyForDeployment\MyProject.dll" "%folder%\MyProject.dll" /y
copy "MyProject.Api\bin\Release\netcoreapp2.2\publish\ReadyForDeployment\MyProject.Api.dll" "%folder%\MyProject.Api.dll" /y
copy "MyProject.Repository\bin\Release\netcoreapp2.2\publish\ReadyForDeployment\MyProject.Repository.dll" "%folder%\MyProject.Repository.dll" /y